          ...
          <table class="w-full whitespace-nowrap">
            <tbody>
              ...
              >
                ...
                <td class="pl-24">
                  <div class="flex items-center">
                    ...
                    />
                    <p
                      class="text-sm leading-none text-gray-600 dark:text-gray-200 ml-2"
                    >
                      Urgent
                    </p>
                  </div>
                ...
                <td class="pl-4">
                  <button
                    class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 dark:text-gray-200 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800 focus:outline-none"
                  >
                    View
                  </button>
                </td>
              ...
              >
                ...
                <td class="pl-5">
                  <button
                    class="py-3 px-6 focus:outline-none text-sm leading-none text-gray-700 dark:text-white dark:bg-gray-800 bg-gray-100 rounded"
                  >
                    Due on 21.02.21
                  </button>
                </td>
              ...
              <tr
                tabindex="0"
                class="focus:outline-none focus:text-indigo-600 h-16 border border-gray-100 dark:border-gray-600 rounded"
              >
                <td>
                  <div class="ml-5">
                    <div
                ...
                <td class="pl-5">
                  <button
                    class="py-3 px-7 text-sm leading-none text-gray-700 dark:text-white bg-gray-100 dark:bg-gray-800 rounded focus:outline-none"
                  >
                    Due tomorrow
                  </button>
                </td>
              ...
              >
                ...
                <td class="pl-5">
                  <button
                    class="py-3 px-7 text-sm leading-none text-gray-700 dark:text-white bg-gray-100 rounded focus:outline-none"
                  >
                    Due tomorrow
                  </button>
                </td>
              ...
              >
                ...
                <td class="pl-5">
                  <button
                    class="py-3 px-3 text-sm leading-none text-gray-700 dark:text-white bg-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800 rounded focus:outline-none"
                  >
                    Due Today at 18:00
                  </button>
                </td>
