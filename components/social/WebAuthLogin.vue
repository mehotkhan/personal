        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="mt-10 flex w-full justify-between text-md text-white">
                <button
                  type="button"
                ...
                <button
                  type="button"
                  class="inline-flex justify-center rounded-md border border-transparent bg-green-500 px-4 py-2"
